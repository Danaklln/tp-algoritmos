...
public:
  ...
  /*
   * Pre: -
   * Post: Devuelve un puntero a Jugador de revelador
   */
  Jugador* getRevelador()
  {
   ...
   * Post: Cambia el atributo revelador al Jugador pasado como
   * parametro
   */
  void setRevelador(Jugador* nuevoRevelador)
  {
    if (!nuevoRevelador) throw "[ERROR] Parametros invalidos";
    this->revelador = nuevoRevelador;
  }
