...
private:
     ...
     * Post: Se modifica el objeto bitmap_image dibujando un tesoro en el cuadrado
     * correspondiente
     */
     ...
     * Pre: Se debe proporcionar un objeto bitmap_image válido y dos coordenadas
     * > 0 dentro del rango del tablero
     * Post: Se modifica el objeto bitmap_image dibujando un espía en el cuadrado
     * correspondiente
     */
     ...
     * Pre: Se debe proporcionar un objeto bitmap_image válido y dos coordenadas
     * > 0 dentro del rango del tablero
     * Post: Se modifica el objeto bitmap_image dibujando una mina en el cuadrado
     * correspondiente
     */
